              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="sidebar-item contact-form">
                    ...
                    <div class="content">
                      <form id="contact" action="{{ route('setnewpass') }}" method="post">
   ...
   @endif
                  ...
                  <div class="row">
                        ...
                        <!-- <div class="row"> -->
                          ...
                          <div class="col-md-12 col-sm-12">
                            <fieldset>
                              <input name="email" type="text" id="email" placeholder="Email" value="{{ $LoggedUserInfoReset['u_email'] }}" readonly>
                            </fieldset>
                          </div>                         
                          <div class="col-md-12 col-sm-12">
                            <fieldset>
                          ...
                          <div class="col-md-12 col-sm-12">
                            <fieldset>
                              <input name="otp" type="text" id="otp" placeholder="OTP" maxlength="6">
                            </fieldset>
                          </div>
